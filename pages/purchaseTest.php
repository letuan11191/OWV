...
<body>
 ...
 <div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header"><!-- <?php echo $_GET['name'];  ?>'s --> Bưu kiện Gửi Đến  </h1>
      </div>
...
?>
<a href="Sendmail.php?name=<?php echo $a1; ?>&email=<?php echo $aa;?>" class ="btn btn-primary"><span>Nhận và gửi mail thông báo</span></a>
</div>
