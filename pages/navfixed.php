...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="home.php">Quản lý tài sản - OWV</a>
			...
			<div class="sidebar-nav navbar-collapse">
				...
				<ul class="nav" id="side-menu">
					...
					<li>
						...
						<a href="taisan.php"><i class="fa fa-table fa-fw"></i> Danh sách tài sản</a>

					</li>
					<li>

						<a href="loaitaisan.php"><i class="fa fa-table fa-fw"></i> Danh sách loại tài sản</a>

					</li>

					<li>

						<a href="phong.php"><i class="fa fa-list-alt fa-fw"></i> Danh sách phòng</a>
					...
					<!-- <li>
						...
						<a href="products2.php"><i class="fa fa-list-alt fa-fw"></i> Danh sách thư tồn 2</a>

					</li>

					<li>

						<a href="products3.php"><i class="fa fa-list-alt fa-fw"></i> Danh sách thư tồn 3</a>

					</li>					

					<li>

						<a href="supplier.php"><i class="fa fa-truck fa-fw"></i> Loại bưu phẩm</a>

					</li>

					<li>

								<a href="sales1.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="fa fa-money fa-fw"></i> Trả bưu phẩm </a>

					</li>

					<li>

								<a href="ngayle.php"><i class="fa fa-calendar fa-fw"></i> Ngày lễ</a>

					</li>

					<li>

								<a href="test_cskh.php"><i class="fa fa-calendar fa-fw"></i> Gửi mail</a>

					</li>

					<li>

								<a href="Noel.php"><i class="fa fa-calendar fa-fw"></i> Gửi mail Noel</a>
