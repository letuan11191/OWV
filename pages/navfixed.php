...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="home.php">Quản lý thư</a>
	</div>
	<!-- /.navbar-header -->
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li>
						<a href="products.php"><i class="fa fa-table fa-fw"></i> Khách Hàng</a>
					</li>
					<li>
						<a href="orderpo.php"><i class="fa fa-list-alt fa-fw"></i> Nhận bưu phẩm</a>
					</li>
					<li>
						<a href="purchaseslist.php"><i class="fa fa-list-alt fa-fw"></i> Danh sách bưu phẩm đã nhận</a>
					</li>
					<li>
