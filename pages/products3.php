...
<body>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Thư tồn 3</h1>
            </div>
             ...
             <!-- <a  href = "#add" data-toggle = "modal" class="btn btn-primary">Thêm Khách Hàng</a> -->
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            $results = $db->prepare("SELECT * from b GROUP BY product_name having max(date_order)
                                AND status='Đã gửi mail lần 2'");
                            $results->execute();
                            ...
                            ?><!-- </tr> -->
                                ...
                                {echo '';}
                                    ...
                                    <a href="Sendmail3.php?name=<?php echo $rrrrr;?>&email=<?php echo $aa;?>&qty=<?php echo $qty;?>" class ="btn btn-warning" title="Gửi mail lần 3"><span><i class="fa fa-send"></i></span></a></td><?php } ?>
                                <?php
