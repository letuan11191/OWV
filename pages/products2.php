...
<body>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Thư tồn 2</h1>
            </div>
             ...
             <!-- <a  href = "#add" data-toggle = "modal" class="btn btn-primary">Thêm Khách Hàng</a> -->
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            $results = $db->prepare("SELECT * from d GROUP BY product_name having max(date_order)
                                AND status='Đã gửi mail lần 1'");
                            $results->execute();
