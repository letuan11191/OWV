        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Thêm loại tài sản</h4>

                </div>

                <div class="modal-body">

                    <form action="SaveAddLoaiTaiSan.php" method="post" class = "form-group" >
                        ...
                        <div id="ac">
                            ...
                            <span>Tên loại tài sản : </span><input type="text" name="tenloaitaisan" class = "form-control" />                            
