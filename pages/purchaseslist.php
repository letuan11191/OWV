        ...
        <div class="container-fluid">
         ...
         <div class="row">
          ...
          <div class="col-lg-12">
           ...
           <h1 class="page-header">Chi tiết di chuyển tài sản</h1>
         ...
         <div id="maintable">
          ...
          <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <thead>
             ...
             <tr>
              ...
              <th class="hidden"> Mã </th>

              <th width="10%"> Ngày nhận </th>

              <th width="10%"> Ngày trả </th>

              <th width="5%"> Loại bưu phẩm </th>
              ...
              <th width="10%"> Tên công ty nhận </th>
          ...
          $result = $db->prepare("SELECT * FROM purchases ORDER BY date_order desc");
          ...
          for($i=0; $row = $result->fetch(); $i++){
            ...
            <tr class="record">
             ...
             <td class="hidden"><?php echo $row['invoice_number']; ?></td>

             <td><?php echo $row['date_order']; ?></td>

             <td><?php 

             if ($row['ngay_tra']=='0000-00-00 00:00:00') {

               echo '' ;

             }else{echo $row['ngay_tra'];}

              ?></td>

             <td><?php echo $row['suplier']; ?></td>

             <td><?php echo $row['nguoi_gui']; ?></td>
             ...
             <td><?php
              ...
              <!-- <?php $array_mail = explode(',', $rowss['email']); ?> -->

              <!-- <?php $array_mail = explode(', ', $aa);
            ...
            <!--  <td><?php
              ...
              <td><?php if ($row['status']=='Khách hàng đã nhận') {
              ...
              <!-- <td><?php
                ...
                <a href="Sendmail.php?name=<?php echo $row['transaction_id'];?>&nguoi_gui=<?php echo $row['nguoi_gui']; ?>&email=<?php echo $aa;?>&invoice_number=<?php echo $row['invoice_number']; ?>" class ="btn btn-primary"><span><i class="fa fa-send"></i></span></a>

                <?php 

                  if (($row['status']=='Khách hàng đã nhận') || ($row['status']=='Đã gửi CPN') ){
                ...
                <a href="incoming2.php?name=<?php echo  $row['p_name']; ?>&qty=<?php echo $row['qty']; ?>&id=<?php echo $row['transaction_id']; ?>" class ="btn btn-warning" title="Trả Thư"><span><i class="fa fa-mail-forward"></i></span></a>

                <?php } ?>

                <!-- <form method="post" action="Sendmail.php">

                    <input class = "btn btn-success" type="submit" name="submit" value="Gửi Mail">
