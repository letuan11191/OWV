...
<span>Mã : </span><input type="text" name="code" class = "form-control" value="<?php echo $row['product_code']; ?>" />
<span>Tên công ty : </span><input type="text" name="bname" class = "form-control" value="<?php echo $row['product_name']; ?>" />
<span>Email(nhập từ 2 mail trở lên theo mẫu: mail1-khoảng trắng mail2) : </span><input type="text" name="email" class = "form-control" value="<?php echo $row['Email']; ?>" />
<span>Ghi chú : </span><input type="text" name="note" class = "form-control" value="<?php echo $row['note']; ?>" />
