        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Thêm loại phòng</h4>

                </div>

                <div class="modal-body">

                    <form action="SaveAddLoaiPhong.php" method="post" class = "form-group" >
                        ...
                        <div id="ac">
                            ...
                            <span>Tên loại phòng : </span><input type="text" name="tenloaiphong" class = "form-control" />                            
