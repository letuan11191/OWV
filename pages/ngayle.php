            ...
            <div class="row">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                     ...
                                     <form action="savengayle.php" method="post" class = "form-group">
                                        <div id="ac">
                                            <span>Sự kiện : </span><input type="text" name="name" class = "form-control" />
                                            <span>Ngày : </span><input type="text" name="day" class = "form-control" />
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM ngayle ORDER BY id DESC");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ?>
                            <tr class="record">
                                <td><?php echo $row['tenngayle']; ?></td>
                                
                                <!--<td><?php echo $row['suplier_address']; ?></td>
                                <td align="right"><?php echo $row['suplier_contact']; ?></td> -->
                                <td><a rel="facebox" class="btn btn-primary" href="editngayle.php?id=<?php echo $row['id']; ?>"> <i class="fa fa-pencil"></i> </a>  <a href="#" id="<?php echo $row['id']; ?>" class="btn btn-danger delbutton" title="Click To Delete"><i class = "fa fa-trash"></i></a>

                                    <a href="template.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" title="Sửa template"><i class = "fa fa-send"></i></a></td>
                            </tr>
                            <?php
                        }
                        ?>
