                ...
                <div class="modal-body">
                    <form action="saveproduct.php" method="post" class = "form-group" >
                        <div id="ac">
                            ...
                            <!-- </select> -->
                            <span>Mã công ty : </span><input type="text" name="code" value = "<?php echo $pcode ?>" class = "form-control" />
                            <span>Tên công ty : </span><input type="text" name="bname" class = "form-control" />
                            <span>Email : </span><input type="text" name="email" class = "form-control" />
                            <span>Ghi chú : </span><input type="text" name="note" class = "form-control" />
                            ...
                            <span>Số lượng thư : </span><input type="text" name="qty" class = "form-control" />
